...
\section{A K-módszer alapgondolata}
...
\end{equation}
ahol a rendszernek $M$ darab "belső" bemente ($y_1...y_M$), $P$ darab "külső" bemenete ($u_1...u_P$) és $N$ darab "belső" kimenete ($x_1...x_N$) van.
...
\begin{subnumcases}{}
    \mathbf{w'}=\mathbf{Aw}+\mathbf{Bu}+\mathbf{Cy} \label{kw}\\
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{figures/tssch.png}
    \caption{A Tube-Screamer áramkör "clipping stage" részének áramköre. Az $R2$ ellenállás egy maximum $500 k\Omega$ értékű 
    logaritmikus potenciométer.}
\end{figure}
...
\begin{figure}[!h]
    ...
    \begin{subfigure}{0.47\textwidth}
        ...
        \caption{A (\ref{diodak}) egyenletben leírt karakterisztikával}
        \label{a}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.47\textwidth}
        ...
        \caption{LTSpice-ból exportált karakterisztikával}
        \label{b}
    \end{subfigure}
